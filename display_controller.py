...
class Display:
    def __init__(self):
        ...
        self.currAlgLbl.place(relx=0.0, rely=0.1, anchor=tkinter.W)
        ...
        self.swapSlider = ctk.CTkSlider(self.root, from_=0, to=0.5, orientation='horizontal', variable=self.swapSD, width=385, number_of_steps=20)
        self.swapSlider.place(relx=0.0, rely=0.5, anchor=tkinter.W)
        self.compareSlider = ctk.CTkSlider(self.root, from_=0, to=0.5, orientation='horizontal', variable=self.compareSD, width=385, number_of_steps=20)
        self.compareSlider.place(relx=0.0, rely=0.7, anchor=tkinter.W)
        ...
        self.nextAlgLbl.place(relx=0.0, rely=0.9, anchor=tkinter.W)
